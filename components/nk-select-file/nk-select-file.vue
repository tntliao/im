...
<script>
	...
	export default {
		...
		props: {
			...
			folderImg: {
				type: String,
				default: mainUrl + '/storage/cert/20220805/bb5cf117b416ad02ac25e1bcf7dcc083.png'
			},
			fileImg: {
				type: String,
			...
			docImg: {
				type: String,
				default: mainUrl + '/storage/cert/20220805/9792591949ec6afe3638178b64e5dc33.png'
			},
			pdfImg: {
				type: String,
			...
			selectedImg: {
				type: String,
				default: mainUrl + '/storage/cert/20220805/8da6bbf75756ebd3f54ee8cfe2bed261.png'
			},
			unselectedImg: {
				type: String,
